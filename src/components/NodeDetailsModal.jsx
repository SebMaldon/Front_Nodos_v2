...
export default function NodeDetailsModal({ selectedNodo, onClose, handleImageClick }) {
    ...
    return (
        <Dialog open={!!selectedNodo} onOpenChange={(open) => !open && onClose()}>
            <DialogContent className="max-w-[95vw] sm:max-w-4xl max-h-[90vh] overflow-y-auto bg-white p-8 rounded-xl border border-slate-200 shadow-xl">
                <DialogHeader>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-slate-50/50 p-5 rounded-xl border border-slate-200/60 space-y-4">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                <div className="space-y-1">
                                    <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Faltantes</p>
